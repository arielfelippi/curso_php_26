...
CREATE TABLE `estado` (
  ...
  PRIMARY KEY (`id`),
  KEY `estado_usuario_FK` (`usuario_alteracao`),
  CONSTRAINT `estado_usuario_FK` FOREIGN KEY (`usuario_alteracao`) REFERENCES `usuario` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (1,'Ariel'),(2,'Rafael'),(3,'Luiz Felipe'),(4,'Bruno'),(5,'Kevin'),(6,'Tiago'),(7,'Henrique B'),(8,'Pedro'),(9,'Henrique Z');
...
-- Dump completed on 2026-01-27 21:44:59
